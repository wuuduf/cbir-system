<template>
  <section class="panel query-panel">
    ...
    <el-form label-position="top" class="form">
      ...
      <el-form-item label="传统特征">
        <el-radio-group v-model="feature" class="feature-grid traditional-grid">
          <el-radio-button v-for="item in traditionalFeatures" :key="item.value" :label="item.value">
            {{ item.label }}
          </el-radio-button>
        </el-radio-group>
      </el-form-item>
      <el-form-item label="深度与综合">
        <el-radio-group v-model="feature" class="feature-grid advanced-grid">
          <el-radio-button v-for="item in advancedFeatures" :key="item.value" :label="item.value">
            {{ item.label }}
          </el-radio-button>
        </el-radio-group>
      </el-form-item>
...
const featureOptions = [...traditionalFeatures, ...advancedFeatures]
const metricOptions = [
